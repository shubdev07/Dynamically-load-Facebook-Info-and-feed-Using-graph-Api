$(function() {
    ...
    function fbInfo (fbtoken){
            ...
            $.ajax('https://graph.facebook.com/me?fields=id,name,email,about,relationship_status,hometown,birthday,gender&access_token=' + fbtoken, {
